...
export default function HomeLiving() {
  ...
  const fetchListings = useCallback(async () => {
    try {
      ...
      results = results.filter(
        (listing) => listing.category?.toLowerCase() === "home & living",
      );
  ...
  function handleSearch(e) {
    e.preventDefault();
    if (searchInput.trim()) {
      navigate(`/search?q=${searchInput.trim()}&category=Home & Living`);
    }
  }
    ...
    <>
      ...
      <div className="flex-1 w-full py-8 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-6">
            <h2 className="text-3xl font-bold text-gray-800">Home & Living</h2>
